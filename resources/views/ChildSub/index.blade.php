@extends('layouts.app', ['activePage' => 'childsub' ])
@section('content')
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class=" row   bg-gray m-1 mb-2 rounded pb-0 ">
                ...
                <div class="col-11  mt-2">
                    <h1 class="text-muted  text-lg  ">سجل اشتراك الاطفال بالخدمات</h1>
                </div>
<hr>
            </div>
...
@push('js')
    <div>
        ...
        @include('ChildSub.delete-ChildSub')
     </div>
