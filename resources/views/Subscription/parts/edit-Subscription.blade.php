     ...
     <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
             <div class="modal-header">
                 <h5 class="modal-title text-center" id="exampleModalLongTitle">تعديل بيانات الاشتراك</h5>
                 ...
                 <form class="m-2 font-weight-bold " id="editForm">
                    ...
                    <div class="form-group">
                     ...
                     <div class="modal-footer justify-content-center">
                         <button type="button" class="btn  btn-info h3" req="no" data-dismiss="modal" id="closeedit">رجوع</button>
                         <button type="button" id="okEdit" req="no" class="btn  btn-success h3">موافق</button>
                     </div>
             ...
             $.ajax({
                 ...
                 success: function(data) {
                     if (data.response == true) {
                         ...
                         table.draw();
                         Alert("تمت عملية تعديل بيانات اللاعب بنجاح", "success")
                         $("#editmodal .close").click();
                         $('.modal-backdrop').hide();
                     } else {
                         Alert("يوجد خطأ", "danger")
                         $("#editmodal .close").click();
                         $('.modal-backdrop').hide();
                     }
                 }
