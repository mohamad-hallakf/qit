@extends('layouts.app', ['activePage' => 'Subscription' ])
@section('content')
    <div class="content">
        ...
        <div class="container-fluid ">
            ...
            <div class=" row   bg-gray m-1 mb-2 rounded pb-0 ">
                <div class="col-11  mt-2">
                    <h1 class="text-muted  text-lg  "> جدول الاشتراكات</h1>
                </div>
                <div class="col-1 mt-2 text-center">
<!-- Button trigger modal -->
<span data-toggle="tooltip" data-placement="auto"  title="اضافة اشتراك جديد">
    <button type="button" class="btn btn-success"  data-toggle="modal" data-target="#addmodel"  id='internalAdding'>
...
@push('js')
    ...
    <div>
        ...
        @include('Subscription.parts.add-Subscription')
        @include('Subscription.parts.delete-Subscription')
        @include('Subscription.parts.edit-Subscription')
    </div>
